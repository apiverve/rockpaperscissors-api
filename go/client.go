...
const (
	baseURL        = "https://api.apiverve.com/v1/rockpaperscissors"
	defaultTimeout = 30 * time.Second
)

// Client is the Rock Paper Scissors API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Rock Paper Scissors API client.
...
// Execute makes a request to the Rock Paper Scissors API with typed parameters.
//
