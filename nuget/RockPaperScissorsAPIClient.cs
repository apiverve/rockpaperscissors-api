...
namespace APIVerve.API.RockPaperScissors
{
    ...
    /// <summary>
    /// Client for the RockPaperScissors API
    /// </summary>
    public class RockPaperScissorsAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/rockpaperscissors";
        ...
        {
            { "choice", new ValidationRule { Type = "string", Required = false } },
            { "rounds", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 100 } }
        };
        ...
        public RockPaperScissorsAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RockPaperScissorsAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RockPaperScissorsAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, RockPaperScissorsQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(RockPaperScissorsQueryOptions options)
        {
        ...
        public ResponseObj Execute(RockPaperScissorsQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(RockPaperScissorsQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(RockPaperScissorsQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(RockPaperScissorsQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(RockPaperScissorsQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(RockPaperScissorsQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(RockPaperScissorsQueryOptions options)
        {
