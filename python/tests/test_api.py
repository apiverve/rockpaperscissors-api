...
class TestRockpaperscissorsAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = RockpaperscissorsAPIClient(self.api_key)

    @patch('apiverve_rockpaperscissors.apiClient.requests.get')
