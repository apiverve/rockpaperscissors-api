# Rock Paper Scissors Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:rockpaperscissors-api:1.1.14'
}
```
...
```java
import com.apiverve.rockpaperscissors.RockPaperScissorsAPIClient;
import com.apiverve.rockpaperscissors.APIResponse;
import com.apiverve.rockpaperscissors.APIException;

// Initialize the client
RockPaperScissorsAPIClient client = new RockPaperScissorsAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("choice", "random");
    parameters.put("rounds", 1);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/rockpaperscissors](https://docs.apiverve.com/ref/rockpaperscissors)
...
- **Documentation:** [https://docs.apiverve.com/ref/rockpaperscissors](https://docs.apiverve.com/ref/rockpaperscissors)
- **Issues:** [GitHub Issues](https://github.com/apiverve/rockpaperscissors-api/issues)
