...
class rockpaperscissorsWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/rockpaperscissors');
        }
        ...
        this.validationRules = {"choice":{"type":"string","required":false,"default":"random"},"rounds":{"type":"integer","required":false,"min":1,"max":100,"default":1}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/rockpaperscissors`);
        }
    }
...
module.exports = rockpaperscissorsWrapper;
