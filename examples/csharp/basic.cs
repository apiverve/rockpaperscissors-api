...
namespace APIVerve.Examples
{
    class RockPaperScissorsExample
    {
        ...
        private static readonly string API_URL = "https://api.apiverve.com/v1/rockpaperscissors";

        /// <summary>
        /// Make a GET request to the Rock Paper Scissors API
        /// </summary>
        static async Task<JsonDocument> CallRockPaperScissorsAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;choice&quot;] &#x3D; &quot;rock&quot;, [&quot;rounds&quot;] &#x3D; 5 };
        ...
        {
            Console.WriteLine("📤 Calling Rock Paper Scissors API...\n");

            var result = await CallRockPaperScissorsAPI();
